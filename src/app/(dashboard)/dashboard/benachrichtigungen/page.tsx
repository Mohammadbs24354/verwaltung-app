        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-100">
            {notifications.map((n) => (
              <div
                key={n.id}
                className={cn("flex items-start gap-4 p-4 transition-colors hover:bg-gray-50 cursor-pointer", !n.gelesen && "bg-blue-50/50")}
                onClick={() => !n.gelesen && markRead(n.id)}
              >
                <div className={cn("mt-1.5 flex h-2 w-2 shrink-0 rounded-full", n.gelesen ? "bg-gray-300" : "bg-blue-500")} />
